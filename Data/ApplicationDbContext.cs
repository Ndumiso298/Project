    ...
    public class ApplicationDbContext : IdentityDbContext<IdentityUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FaultReport>(entity =>
            {
                ...
                // the self-referencing relationship for relaunched faults
            ...
            modelBuilder.Entity<Fridge>().HasData(
                ...
                new Fridge { FridgeId = 8, Brand = "Kelvinator", Model = "KRF265", CapacityLiters = 265, Type = "Top Mount", Description = "Affordable fridge with efficient cooling", RentalPricePerMonth = 430, ImageUrl = "Images/Fridges/06d99650-49bb-46a0-9c87-479b064e20cf.jpg", AvailabilityStatus = "Available", Location = "Cape Town" },
            ...
            // THEN Seed FridgeInStocks (after Fridges are seeded)
            modelBuilder.Entity<FridgeInStock>().HasData(
                // Fridge 1
                new FridgeInStock { FridgeInStockId = 1, FridgeNo = "FRG001", LastMaintenanceDate = new DateTime(2025, 3, 12), Condition = "Excellent", IsAvailable = true, Location = "Durban", FridgeId = 1, Quantity = 0 },
                new FridgeInStock { FridgeInStockId = 2, FridgeNo = "FRG002", LastMaintenanceDate = new DateTime(2025, 1, 8), Condition = "Good", IsAvailable = false, Location = "Durban", FridgeId = 1, Quantity = 0 },

                // Fridge 2
                new FridgeInStock { FridgeInStockId = 3, FridgeNo = "FRG003", LastMaintenanceDate = new DateTime(2025, 4, 5), Condition = "Excellent", IsAvailable = true, Location = "Johannesburg", FridgeId = 2, Quantity = 0 },
                new FridgeInStock { FridgeInStockId = 4, FridgeNo = "FRG004", LastMaintenanceDate = new DateTime(2025, 2, 10), Condition = "Good", IsAvailable = false, Location = "Johannesburg", FridgeId = 2, Quantity = 0 },

                // Fridge 3
                new FridgeInStock { FridgeInStockId = 5, FridgeNo = "FRG005", LastMaintenanceDate = new DateTime(2025, 5, 20), Condition = "Fair", IsAvailable = false, Location = "Cape Town", FridgeId = 3, Quantity = 0 },
                new FridgeInStock { FridgeInStockId = 6, FridgeNo = "FRG006", LastMaintenanceDate = new DateTime(2025, 6, 11), Condition = "Excellent", IsAvailable = true, Location = "Cape Town", FridgeId = 3, Quantity = 0 },

                // Fridge 4
                new FridgeInStock { FridgeInStockId = 7, FridgeNo = "FRG007", LastMaintenanceDate = new DateTime(2025, 4, 1), Condition = "Good", IsAvailable = true, Location = "Pretoria", FridgeId = 4, Quantity = 0 },
                new FridgeInStock { FridgeInStockId = 8, FridgeNo = "FRG008", LastMaintenanceDate = new DateTime(2025, 2, 15), Condition = "Fair", IsAvailable = false, Location = "Pretoria", FridgeId = 4, Quantity = 0 },

                // Fridge 5
                new FridgeInStock { FridgeInStockId = 9, FridgeNo = "FRG009", LastMaintenanceDate = new DateTime(2025, 1, 30), Condition = "Good", IsAvailable = true, Location = "Durban", FridgeId = 5, Quantity = 0 },
                new FridgeInStock { FridgeInStockId = 10, FridgeNo = "FRG010", LastMaintenanceDate = new DateTime(2025, 5, 3), Condition = "Excellent", IsAvailable = true, Location = "Durban", FridgeId = 5, Quantity = 0 },

                // Fridge 6
                new FridgeInStock { FridgeInStockId = 11, FridgeNo = "FRG011", LastMaintenanceDate = new DateTime(2025, 3, 19), Condition = "Good", IsAvailable = false, Location = "Port Elizabeth", FridgeId = 6, Quantity = 0 },
                new FridgeInStock { FridgeInStockId = 12, FridgeNo = "FRG012", LastMaintenanceDate = new DateTime(2025, 6, 7), Condition = "Excellent", IsAvailable = true, Location = "Port Elizabeth", FridgeId = 6, Quantity = 0 },

                // Fridge 7
                new FridgeInStock { FridgeInStockId = 13, FridgeNo = "FRG013", LastMaintenanceDate = new DateTime(2025, 4, 4), Condition = "Excellent", IsAvailable = true, Location = "Johannesburg", FridgeId = 7, Quantity = 0 },
                new FridgeInStock { FridgeInStockId = 14, FridgeNo = "FRG014", LastMaintenanceDate = new DateTime(2025, 3, 11), Condition = "Fair", IsAvailable = false, Location = "Johannesburg", FridgeId = 7, Quantity = 0 },

                // Fridge 8
                new FridgeInStock { FridgeInStockId = 15, FridgeNo = "FRG015", LastMaintenanceDate = new DateTime(2025, 2, 26), Condition = "Good", IsAvailable = true, Location = "Cape Town", FridgeId = 8, Quantity = 0 },
                new FridgeInStock { FridgeInStockId = 16, FridgeNo = "FRG016", LastMaintenanceDate = new DateTime(2025, 4, 9), Condition = "Excellent", IsAvailable = false, Location = "Cape Town", FridgeId = 8, Quantity = 0 },

                // Fridge 9
                new FridgeInStock { FridgeInStockId = 17, FridgeNo = "FRG017", LastMaintenanceDate = new DateTime(2025, 1, 17), Condition = "Good", IsAvailable = true, Location = "Pretoria", FridgeId = 9, Quantity = 0 },
                new FridgeInStock { FridgeInStockId = 18, FridgeNo = "FRG018", LastMaintenanceDate = new DateTime(2025, 6, 2), Condition = "Excellent", IsAvailable = false, Location = "Pretoria", FridgeId = 9, Quantity = 0 },

                // Fridge 10
                new FridgeInStock { FridgeInStockId = 19, FridgeNo = "FRG019", LastMaintenanceDate = new DateTime(2025, 3, 8), Condition = "Fair", IsAvailable = false, Location = "Durban", FridgeId = 10, Quantity = 0 },
                new FridgeInStock { FridgeInStockId = 20, FridgeNo = "FRG020", LastMaintenanceDate = new DateTime(2025, 5, 13), Condition = "Excellent", IsAvailable = true, Location = "Durban", FridgeId = 10, Quantity = 0 },

                // Fridge 11
                new FridgeInStock { FridgeInStockId = 21, FridgeNo = "FRG021", LastMaintenanceDate = new DateTime(2025, 3, 6), Condition = "Excellent", IsAvailable = true, Location = "Bloemfontein", FridgeId = 11, Quantity = 0 },
                new FridgeInStock { FridgeInStockId = 22, FridgeNo = "FRG022", LastMaintenanceDate = new DateTime(2025, 2, 18), Condition = "Fair", IsAvailable = false, Location = "Bloemfontein", FridgeId = 11, Quantity = 0 },

                // Fridge 12
                new FridgeInStock { FridgeInStockId = 23, FridgeNo = "FRG023", LastMaintenanceDate = new DateTime(2025, 5, 25), Condition = "Good", IsAvailable = false, Location = "Cape Town", FridgeId = 12, Quantity = 0 },
                new FridgeInStock { FridgeInStockId = 24, FridgeNo = "FRG024", LastMaintenanceDate = new DateTime(2025, 6, 10), Condition = "Excellent", IsAvailable = true, Location = "Cape Town", FridgeId = 12, Quantity = 0 },

                // Fridge 13
                new FridgeInStock { FridgeInStockId = 25, FridgeNo = "FRG025", LastMaintenanceDate = new DateTime(2025, 1, 21), Condition = "Good", IsAvailable = true, Location = "Durban", FridgeId = 13, Quantity = 0 },
                new FridgeInStock { FridgeInStockId = 26, FridgeNo = "FRG026", LastMaintenanceDate = new DateTime(2025, 4, 27), Condition = "Fair", IsAvailable = false, Location = "Durban", FridgeId = 13, Quantity = 0 },

                // Fridge 14
                new FridgeInStock { FridgeInStockId = 27, FridgeNo = "FRG027", LastMaintenanceDate = new DateTime(2025, 3, 14), Condition = "Excellent", IsAvailable = false, Location = "Pretoria", FridgeId = 14, Quantity = 0 },
                new FridgeInStock { FridgeInStockId = 28, FridgeNo = "FRG028", LastMaintenanceDate = new DateTime(2025, 6, 20), Condition = "Good", IsAvailable = true, Location = "Pretoria", FridgeId = 14, Quantity = 0 },

                // Fridge 15
                new FridgeInStock { FridgeInStockId = 29, FridgeNo = "FRG029", LastMaintenanceDate = new DateTime(2025, 2, 2), Condition = "Excellent", IsAvailable = true, Location = "Johannesburg", FridgeId = 15, Quantity = 0 },
                new FridgeInStock { FridgeInStockId = 30, FridgeNo = "FRG030", LastMaintenanceDate = new DateTime(2025, 4, 17), Condition = "Fair", IsAvailable = false, Location = "Johannesburg", FridgeId = 15, Quantity = 0 },

                // Fridge 16
                new FridgeInStock { FridgeInStockId = 31, FridgeNo = "FRG031", LastMaintenanceDate = new DateTime(2025, 5, 22), Condition = "Excellent", IsAvailable = true, Location = "Durban", FridgeId = 16, Quantity = 0 },
                new FridgeInStock { FridgeInStockId = 32, FridgeNo = "FRG032", LastMaintenanceDate = new DateTime(2025, 3, 10), Condition = "Good", IsAvailable = false, Location = "Durban", FridgeId = 16, Quantity = 0 },

                // Fridge 17
                new FridgeInStock { FridgeInStockId = 33, FridgeNo = "FRG033", LastMaintenanceDate = new DateTime(2025, 1, 25), Condition = "Fair", IsAvailable = false, Location = "Cape Town", FridgeId = 17, Quantity = 0 },
                new FridgeInStock { FridgeInStockId = 34, FridgeNo = "FRG034", LastMaintenanceDate = new DateTime(2025, 6, 5), Condition = "Excellent", IsAvailable = true, Location = "Cape Town", FridgeId = 17, Quantity = 0 },

                // Fridge 18
                new FridgeInStock { FridgeInStockId = 35, FridgeNo = "FRG035", LastMaintenanceDate = new DateTime(2025, 4, 12), Condition = "Good", IsAvailable = true, Location = "Johannesburg", FridgeId = 18, Quantity = 0 },
                new FridgeInStock { FridgeInStockId = 36, FridgeNo = "FRG036", LastMaintenanceDate = new DateTime(2025, 2, 28), Condition = "Fair", IsAvailable = false, Location = "Johannesburg", FridgeId = 18, Quantity = 0 },

                // Fridge 19
                new FridgeInStock { FridgeInStockId = 37, FridgeNo = "FRG037", LastMaintenanceDate = new DateTime(2025, 5, 30), Condition = "Excellent", IsAvailable = true, Location = "Pretoria", FridgeId = 19, Quantity = 0 },
                new FridgeInStock { FridgeInStockId = 38, FridgeNo = "FRG038", LastMaintenanceDate = new DateTime(2025, 6, 14), Condition = "Good", IsAvailable = false, Location = "Pretoria", FridgeId = 19, Quantity = 0 },

                // Fridge 20
                new FridgeInStock { FridgeInStockId = 39, FridgeNo = "FRG039", LastMaintenanceDate = new DateTime(2025, 1, 9), Condition = "Fair", IsAvailable = false, Location = "Durban", FridgeId = 20, Quantity = 0 },
                new FridgeInStock { FridgeInStockId = 40, FridgeNo = "FRG040", LastMaintenanceDate = new DateTime(2025, 5, 18), Condition = "Excellent", IsAvailable = true, Location = "Durban", FridgeId = 20, Quantity = 0 }
            );
        }
    }
}