...
public class ReplacementRequestsController : Controller
{
    ...
    [Authorize(Roles = "InventoryLiaison,CustomerLiaison,Administrator")]
    ...
    [Authorize(Roles = "CustomerLiaison,Administrator")]
    ...
    [Authorize(Roles = "InventoryLiaison,Administrator")]
