...
namespace Project.Migrations
{
    ...
    [Migration("20251026110051_replacement")]
            ...
            modelBuilder.Entity("Project.Models.ReplacementRequest", b =>
                {
                    ...
                    b.Property<int?>("RespondedByEmployeeId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SupportResponse")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("OldFridgeId");

                    b.HasIndex("RespondedByEmployeeId");

                    b.ToTable("tblReplacementRequests");
                });
            ...
            modelBuilder.Entity("Project.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "admin-id-123",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d5ebeeb3-9e7d-4331-9607-3187844236d2",
                            Email = "admin@fridgesystem.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@FRIDGESYSTEM.COM",
                            NormalizedUserName = "ADMIN@FRIDGESYSTEM.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEEbJ+YK1eVNTNCtna0CyiOrKUiH22ghqZhdW4osl1vlEltPMOo4kqMcoLSzHIBUKBA==",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "d494b649-b729-4eda-81e9-066195cd4812",
            ...
            modelBuilder.Entity("Project.Models.ReplacementRequest", b =>
                {
                    ...
                    b.HasOne("Project.Models.Fridge", "OldFridge")
                        .WithMany()
                        .HasForeignKey("OldFridgeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Project.Models.Employee", "RespondedByEmployee")
                        .WithMany()
